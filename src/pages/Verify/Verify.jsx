...
export default function Verify() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-orange-50 px-4">
      <div className="max-w-md w-full animate-fade-in">
        {success === "true" ? (
          <div className="bg-gradient-to-br from-orange-700 to-orange-500 rounded-2xl p-8 text-center shadow-xl border border-red-300 transform transition-all duration-300 hover:scale-105">
          ...
          <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-2xl p-8 text-center shadow-xl border border-red-400 transform transition-all duration-300 hover:scale-105">
            ...
            <div className="flex gap-4 justify-center">
              <button className="bg-white text-orange-600 font-bold px-6 py-3 rounded-lg hover:bg-red-50 transition-colors duration-200">
                Try Again
              </button>
